 ...
 *   node "F:\...\Dev\2 - Projects\Advocacia\Ana_Souza-Site_Institucional\setup.js"
 *
...
if (!fs.existsSync(escopoPath)) {
  ...
  console.error("   Certifique-se de rodar o script a partir do vault ou use o caminho absoluto.");
  process.exit(1);
}
