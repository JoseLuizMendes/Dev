...
**CONTRATANTE:** , [Nacionalidade], [Estado Civil], inscrito(a) no CPF sob o n° [Número do CPF], residente na [Endereço Completo], e endereço eletrônico [E-mail]

**CONTRATADO(A):** JOSÉ LUIZ DOS SANTOS AZEREDO MENDES, Brasil, casado(a), inscrito(a) no CPF sob o n° 20858609746, residente na Rua: Ladeira Doutor Bezerra de Menezes, e endereço eletrônico josemendess004@gmail.com
...
**2.** Os serviços serão prestados pelo(a) **CONTRATADO(A)** durante o período [Ex: 2 (duas) vezes no mês] a partir da assinatura do presente Contrato, não sendo mantido qualquer vínculo empregatício/trabalhista ou relação, além do retratado acima.

**3.** Para iniciar o processo de desenvolvimento do Website o(a) **CONTRATANTE** deve fornecer informações sobre o produto desejado, para que o site formulado possa contar com: [Exs: Inserir estrutura da página como: home; contato; rotativo com notícias na página inicial; galeria de fotos; objetivo/atuação], sendo que a execução dessas atividades pelo(a) **CONTRATADO(A)** deverá seguir o Cronograma, ou seja, deve observar os seguintes prazos a contar da assinatura deste Contrato:

a) Planejamento e criação - b) Desenvolvimento - c) Implantação - d) Entrega -

**4.** O(A) **CONTRATANTE** compromete-se a pagar ao(à) **CONTRATADO(A)**, por meio de a quantia de R$ [Valor],

**a.** na hipótese de atraso do pagamento por culpa exclusiva do(a) **CONTRATANTE**, haverá incidência de multa de 2% (dois por cento) sobre o valor devido, além de juros de 1% (um por cento) ao mês, _pro rata die_, até a data do efetivo pagamento.

**b.** o valor supramencionado poderá ser reajustado com base no índice de correção monetária [Inserir Índice], devendo para tanto ser assinado termo aditivo contendo os novos valores ajustados.
...
**g.** compromete-se a não divulgar, transferir, fornecer ou ceder, a qualquer título, quaisquer dados ou informações do(a) **CONTRATANTE** e dos visitantes deste site, contidos no banco de dados e/ou obtidos por força do presente Contrato.
...
**d.** responsabiliza-se legalmente pelos dados e informações armazenadas no site, por essa razão qualquer infração legal, nos âmbitos civil, penal, autoral, dentre outros, que eventualmente venham a ser cometidas com a utilização do site serão de sua competência.

## Vigência

**7.** A vigência do Contrato é firmada [Inserir Prazo/Condição].
...
**17.** Elegem as Partes o Foro da comarca de [Inserir Cidade/Estado] para conhecer e dirimir quaisquer dúvidas ou discussões oriundas deste Contrato, com renúncia a qualquer outro, por mais especial e privilegiado que seja.
...
1. Nome: _________________________________ CPF n°: ________________________________
    
2. Nome: _________________________________ CPF n°: ________________________________