...
4. Se houver projeto ativo: ler `INIT.md` do projeto
...
- **Stack é definida por projeto** no `INIT.md` — ver `Preferencias Dev.md` para as opções aprovadas
...
├── INIT.md                       ← template de bootstrap de projeto
